(() => {
  ...
  const renderSuccess = () => {
    ...
    content.innerHTML = `<section class="booking-success"><div class="booking-success-inner"><div class="booking-success-mark">✓</div><span class="eyebrow">Reserva registrada</span><h2>Seu horário está garantido.</h2><p>Envie a confirmação para Wellington Baroni concluir o atendimento. Dúvidas: 11 94839-9275.</p><div class="booking-success-actions"><a class="btn btn-solid" href="${whatsappUrl(message)}">Enviar no WhatsApp</a><a class="btn" href="${INSTAGRAM_URL}" target="_blank" rel="noopener">Ver Instagram</a><a class="btn" href="${calendarUrl}" download="black-naipe-agendamento.ics">Adicionar ao calendário</a><a class="btn" href="index.html">Voltar para o início</a></div></div></section>`;
  };
